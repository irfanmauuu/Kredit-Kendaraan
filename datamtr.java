...
public class datamtr extends JFrame{
...
// DATA MOTOR TERSEDIA
	...
	btn_djual = new JButton("DATA MOTOR TERJUAL");
...
btn_djual.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
					dataterjual jual = new dataterjual();	
...
btn_cari.addActionListener(new ActionListener() {
			...
			koneksi.close();
						...
						JOptionPane.showMessageDialog(rootPane, x, "CAEI KODE ADA YANG EROR!!!", JOptionPane.ERROR_MESSAGE);
				}	
