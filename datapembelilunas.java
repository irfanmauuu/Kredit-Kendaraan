...
public class datapembelilunas extends JFrame{
...
// DATA MOTOR TERSEDIA
	...
	title1 = new JLabel("DATA PEMBELI LUNAS");
	...
	btn_djual = new JButton("DATA PEMBELI");
	btn_djual.setBounds(1050,10,180,30);
	btn_djual.setToolTipText("MENAMPILKAN DATA PEMBELI YANG BELUM LUNAS");
...
btn_djual.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
					datapembeli mtr = new datapembeli();	
					mtr.setVisible(true);
					dispose();
			}
		});
...
public static void main (String args[]) {
	datapembelilunas beli = new datapembelilunas();
